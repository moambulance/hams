...
export class DriverService {
  ...
  //   GET
  // /driver/getDriversByHospital/{hospital_id}
  // Get Driver By hospital_id
  getAllDriversByHospitalId(hospital_id: any) {
    return this.http.get(
      this.baseUrl + `driver/getDriversByHospital/` + hospital_id,
    );
  }
  // GET
  ...
  getAllActiveApproveDriversByHospitalId(hId: any) {
    return this.http.get(
      this.baseUrl + 'driver/getAllActiveApproveDriversByHospitalId/' + hId,
    );
  }
}
