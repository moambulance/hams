...
export class OrdersService {
  ...
  // GET
  // /orders/hospitalOrders/{hospital_id}/{orderBy}
  // List All Orders By Hospital Id
  getOrdersByHospitalId(hospital_id: any, orderBy: any) {
    return this.http.get(
      this.baseUrl + `orders/hospitalOrders/${hospital_id}/${orderBy}`,
    );
  }
  
  findOrdersByAmbulanceId(ambulance_id: any) {
    return this.http.get(this.baseUrl + `orders/findOntripOrderByAmbulance/${ambulance_id}`);
  }
}
